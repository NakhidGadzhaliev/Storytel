...
struct StoryBrain {
    ...
    func getStoryTitle() -> String {
        return stories[choiceNumber].title
    }
    
    func getChoiceOne() -> String {
        return stories[choiceNumber].choice1
    }
    
    func getChoiceTwo() -> String {
        return stories[choiceNumber].choice2
    }
    
    mutating func nextStory(userChoice: String) {
        let currentStory = stories[choiceNumber]
        
        if userChoice == currentStory.choice1 {
            choiceNumber = currentStory.choice1Destination
        } else {
            choiceNumber = currentStory.choice2Destination
        }
    }
